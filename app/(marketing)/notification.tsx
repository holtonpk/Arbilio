    ...
    <div className="flex w-fit  mx-auto">
      ...
      >
        <motion.li
          ...
          className="w-[70%] min-w-fit rounded-xl bg-primary/10 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.2)] backdrop-blur  p-3 relative flex justify-center items-center  "
        >
